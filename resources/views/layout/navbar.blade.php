        ...
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{url('admin/slider')}}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Main Slider</a>
                    </li>
                    <li>
                        <a href="{{url('admin/home-about')}}"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> About Us</a>
                    </li>
                    <li>
                        <a href="invoice-add.html"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Offer</a>
                    </li>
                    <li>
