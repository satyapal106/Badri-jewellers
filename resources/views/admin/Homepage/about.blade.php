...
@section('body')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Home About </h6>
        <ul class="d-flex align-items-center gap-2">
            ...
            <li>-</li>
            <li class="fw-medium">Home About</li>
        </ul>
    </div>
    <div class="row gy-4">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title mb-0">Home About</h6>
                </div>
                <div class="card-body">
                    <form action="{{ url('admin/home-about') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="sub_heading" class="form-control" placeholder="Sub Heading">
                            </div>
                            <div class="col-md-12">
